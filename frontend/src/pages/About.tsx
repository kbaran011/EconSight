...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      'IBM consulting deck: problem → methodology → findings → recommendations',
        ...
        <div className="flex items-start gap-5">
          ...
          <div>
            ...
            <p className="text-[15px] text-slate-600 leading-relaxed max-w-2xl">
              ...
              consulting capability across data engineering, econometric modelling, and AI-powered insight delivery.
              Designed as a portfolio project targeting the{' '}
              <span className="font-medium text-slate-800">IBM Montreal Strategy & Data Consulting</span> practice.
            </p>
            <div className="flex flex-wrap gap-2 mt-4">
              {['McGill B.Sc. CS & Economics', 'IBM Portfolio', 'Phase 3 of 4 Complete'].map(tag => (
